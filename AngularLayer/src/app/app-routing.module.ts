...
const routes: Routes = [
  ...
  {path: 'create_user_profile', component: CreateUserProfileComponent },
  {path: 'display', component: DisplayAllProductsComponent },
  {path: 'does_username_already_exist', component: DoesUserNameAlreadyExistComponent },
  {path: 'edit_profile', component: EditProfileComponent },
  {path: 'Is_Account_Admin', component: IsAccountAdminComponent },
